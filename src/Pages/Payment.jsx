  ...
  return (
    <div>
      ...
      >
        ...
        <input type="hidden" id="success_url" name="success_url" value="https://localhost:5173/success" required />
        <input type="text" id="failure_url" name="failure_url" value="https://localhost:5173/failure" required />
